            ...
            <div id="comment_form">
                ...
                <form action="" method="post">
                    ...
                    <div class="form_row">
                        ...
                        <br />
                        <input type="text" value="<?=$users->login?>" name="login" />
                    </div>
                    ...
                    <div class="form_row">
                        ...
                        <br />
                        <input type="file" name="img" id="filePhoto" class="required borrowerImageFile" data-errormsg="PhotoUploadErrorMsg"/>
<br\>
                        <img  id="previewHolder" src="regupl/<?=$users->img?>" width="100px" height="100px" />
